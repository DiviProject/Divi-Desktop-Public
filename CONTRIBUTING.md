...
When bug is found or new feature/suggestion proposed, [new Issue gets created](https://github.com/Divicoin/divi-desktop/issues). Our repo has predefined Issue template to help you started with that (the more info you provide the better).
...
When your code is complete and ready, [submit new Pull Request](https://github.com/Divicoin/divi-desktop/compare).
