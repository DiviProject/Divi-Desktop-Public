...
class Manager {
  ...
  _runSanityCheck (client, binPath) {
    ...
    .then(() => {
      ...
      // th3brink: FIX divid so version doesn't return 1
      // th3brink: divid isn't finishing properly and is breaking the sanity check.
      return Promise.resolve({
        stdout: 'Divi Core Daemon version -dirty', // Divi Core Daemon 0.16.0.5 | Divi Core Daemon version -dirty
        stderr: ''
      })
    })
    .then((output) => {
